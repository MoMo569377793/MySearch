...
MATRIX_FREE_FEM_TOPIC_DEFAULT = {
    ...
    "seed_papers": [
        ...
        },
        {
            ...
            "pdf_url": "https://dealii.org/deal97-preprint.pdf",
...
AI_OPERATOR_ACCELERATION_TOPIC_DEFAULT = {
    ...
    "must_match_groups": [
        ["gpu", "cuda", "tensor core", "wmma", "mma", "arm", "sve", "sme", "simd", "avx512", "neon"],
        ["triton", "tvm", "mlir", "xla", "halide", "inductor", "cutlass", "cute", "cublas", "tensorrt"],
        ["benchmark", "roofline", "scaling", "throughput", "latency", "memory bandwidth", "utilization", "occupancy"],
    ],
    "positive_keywords": [
        "cutlass",
        "triton",
    ...
    "seed_papers": [
        ...
        },
        {
            ...
            "year": 2024,
            "venue": "arXiv",
            "primary_url": "https://arxiv.org/abs/2407.08608",
            "arxiv_id": "2407.08608",
            "tags": ["curated-seed", "flashattention"],
        },
        {
            ...
            "year": 2019,
            "venue": "MPC / arXiv",
            "primary_url": "https://doi.org/10.1145/3315508.3329973",
        ...
        },
        {
            ...
            "year": 2018,
            "venue": "OSDI",
            "primary_url": "https://arxiv.org/abs/1802.04799",
            "arxiv_id": "1802.04799",
        ...
        },
        {
            ...
            "pdf_url": "https://zenodo.org/record/1236156/files/article.pdf?download=1",
...
def _build_topic_config(raw: dict) -> TopicConfig:
    ...
    if preset and "required_keyword_groups" not in raw and "required_keyword_lanes" not in raw:
        raw = dict(preset)
    elif preset:
        merged = dict(preset)
        merged.update(raw)
    ...
    return TopicConfig(
        ...
        required_keyword_lanes=[
            [[str(keyword) for keyword in group] for group in lane]
            for lane in raw.get("required_keyword_lanes", [])
        ],
        must_match_groups=[
            [str(keyword) for keyword in group]
